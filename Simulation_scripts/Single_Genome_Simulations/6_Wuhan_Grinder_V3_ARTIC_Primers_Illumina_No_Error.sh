...
output='/scratch/mandyh/WISER_InSilico/Amplicon/sim_V3_Wh1_Illumina_reads'
final_output='/scratch/mandyh/WISER_InSilico/Amplicon/final_sim_V3_Wh1_Illumina_reads'
...
grinder -reference_file $genomes/Wuhan-Hu-1_SARS-COV-2.fasta -forward_reverse $input/V3_POS$i\.fas -coverage_fold $y -read_dist $x -insert_dist 350 -mate_orientation FR -mutation_dist 0 0 -qual_levels 30 10 -fastq_output 1 -output_dir $output/ -base_name Wh1_POS$i\_PE$x\_$y\X_$z
done
done
done
done
